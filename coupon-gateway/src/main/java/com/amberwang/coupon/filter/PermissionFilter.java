package com.amberwang.coupon.filter;

import com.alibaba.fastjson.JSON;
import com.amberwang.coupon.permission.PermissionClient;
...
public class PermissionFilter extends AbsSecurityFilter {
    ...
    protected Boolean interceptCheck(HttpServletRequest request,
        ...
        String uri = request.getRequestURI().substring("/amberwang".length()); // 不需要前缀
